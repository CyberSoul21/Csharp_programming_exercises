...
{
    class Producto_y_Transpuesta
    { //Declaracion de variables que se usaran a durante el programa..
        private int[,] matrizA;
        private int[,] matrizB;
        private int[,] matrizC;
        private int[,] TranspuestaProducto;
        private Random rnd;
        const int SIZE_MATRIZ = 4;
        public Producto_y_Transpuesta()
        {
            this.TranspuestaProducto = new int[SIZE_MATRIZ, SIZE_MATRIZ];
        ...
        //La matriz C es el producto de la matriz A Y B metodo para hacer esta operacion..
        ...
        public void transponer()
        {
            for (int i = 0; i < SIZE_MATRIZ; i++)
            {
                for (int j = 0; j < SIZE_MATRIZ; j++)
                {
                    TranspuestaProducto[i, j] = matrizC[j, i];
                }
            }
        }
        public void imprimir_Transponer()
        {
            ...
            for (int i = 0; i < SIZE_MATRIZ; i++)
            {
                for (int j = 0; j < SIZE_MATRIZ; j++)
                {
                    salida += TranspuestaProducto[i, j] + "\t";
                }
                salida += "\n";
            }
            System.Console.Write(salida);
